...
type UserResourc struct {
	users map[string]User
}

//func (u UserResourc) Register(container *restful.Container) {
...
//	ws.Route(ws.PUT("/{user-id}").To(u.createUser1))
...
//func (u *UserResourc) updateUsers(request *restful.Request, response *restful.Response) {
//	usr := new(User)
...
//func (u *UserResource) createUser1(request *restful.Request, response *restful.Response) {
...
//func (u *UserResource) removeUser1(request *restful.Request, response *restful.Response) {
//	id := request.PathParameter("user-id")
//	delete(u.users, id)
//}
//
